 ...
 * /src/App.tsx
 *
 * Interactive version of the app with usability enhancements
 */
...
import { TimeAllocationSliders, ResourceImpactPreview } from './interface/components/useOfTime';
...
} from './infrastructure/state/middleware/simulation';
...
const GameInitializer: React.FC = () => {
  ...
  const { initialize: initGameLoop, start: startGameLoop } = useRealTimeGameLoop(false);
...
const GameContainer: React.FC = () => {
  ...
  return (
    <div className="game-container">
      ...
      <div className="game-sidebar" data-testid="news-stream">
        <NewsStream />
      </div>
